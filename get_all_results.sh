...
# =====================
TOP_K=5
N_CFX_INTERACTIONS=20
N_NON_CFX_INTERACTIONS=20
MIN_CFX_INTERACTIONS=3
MAX_CFX_REMOVALS=50
TARGET_CFX_RANK=5
N_JUDGED_INTERACTIONS=20

EVALUATION_USER_BATCH_SIZE=16

ATTRIBUTION_METHODS=("jaccard" "cosine" "shap" "lxr" "spinrec" "lime" "accent")
GENERATION_MODEL_IDS=("mistralai/Ministral-8B-Instruct-2410" "google/gemma-3-12b-it" "Qwen/Qwen3-8B")
...
TRAIN_SAMPLE_USER_COUNT=768
EVAL_SAMPLE_USER_COUNT=256

TRAIN_A_GENERATION_BATCH_SIZE=16
TRAIN_B_GENERATION_BATCH_SIZE=16
